...
void __vector_unused_irq  () { for(;;) { mcal_cpu_nop(); } }
void __nmi_handler        () { for(;;) { mcal_cpu_nop(); } }
void __hard_fault_handler () { for(;;) { mcal_cpu_nop(); } }
void __mem_manage_handler () { for(;;) { mcal_cpu_nop(); } }
void __bus_fault_handler  () { for(;;) { mcal_cpu_nop(); } }
void __usage_fault_handler() { for(;;) { mcal_cpu_nop(); } }
void __svc_handler        () { for(;;) { mcal_cpu_nop(); } }
void __debug_mon_handler  () { for(;;) { mcal_cpu_nop(); } }
void __pend_sv_handler    () { for(;;) { mcal_cpu_nop(); } }

void __sys_tick_handler   () { for(;;) { mcal_cpu_nop(); } }


typedef void(*isr_type)();
#define NUMBER_OF_INTERRUPTS  (128U)

const volatile isr_type __isr_vector[NUMBER_OF_INTERRUPTS] __attribute__((section(".isr_vector"))) =
{
