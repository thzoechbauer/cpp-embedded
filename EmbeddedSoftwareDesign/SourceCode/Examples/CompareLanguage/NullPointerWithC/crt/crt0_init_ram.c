...
void crt_init_ram()
{
    ...
    size_t data_size = (memory_aligned_type*)&_data_end
                     - (memory_aligned_type*)&_data_begin;
    memcpy((void*)&_data_begin, (void*)&_rom_data_begin,
        data_size*sizeof(memory_aligned_type));

    // Clear the bss segment.
    // Note that the bss segment is aligned by 4.
    size_t bss_size = (memory_aligned_type*)&_bss_end
                    - (memory_aligned_type*)&_bss_begin;
